...
cmake -DCMAKE_C_COMPILER="$USED_COMPILER_C" -DCMAKE_CXX_COMPILER="$USED_COMPILER_CPP" -S . -B "cmake-build-$USED_COMPILER_C"
ln -sf "./cmake-build-$USED_COMPILER_C/compile_commands.json" "compile_commands.json"
