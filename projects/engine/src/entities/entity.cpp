...
void Entity::DrawImGui(World* world, int index) {
   ...
   if (ImGui::TreeNode(name.c_str())) {
      ...
      ImGui::Text("Name:");
      ImGui::SameLine();
      ImGui::PushID("entity_editor_name"); ImGui::PushID(index);
	 ...
	 nameBuffer.resize(0);
      ...
      ImGui::PushID("entity_editor_transform"); ImGui::PushID(index);
	 ...
	 ImGui::TreePop();
      ...
      ImGui::PushID("entity_editor_models_add"); ImGui::PushID(index);
      if (ImGui::Button("+")) 
	 models.emplace_back(nullptr);
      ImGui::PopID(); ImGui::PopID();

      ImGui::SameLine();
      ImGui::PushID("entity_editor_models"); ImGui::PushID(index);
	 ...
	 for (auto& model : models) {	    
	    ...
	    ImGui::PushID("entity_editor_models_del_entry"); ImGui::PushID(m); ImGui::PushID("_"); ImGui::PushID(index);
	    if (ImGui::Button("X")) {
	    ...
	    ImGui::PushID("entity_editor_models_list"); ImGui::PushID(index); ImGui::PushID(m);
	    if (ImGui::BeginCombo("##model", modelName)) {
		  ...
		  ImGui::PushID("entity_editor_models_list_entry"); ImGui::PushID(index); ImGui::PushID(m);
